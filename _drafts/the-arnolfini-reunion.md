...
Within this area two similar forms can be discerned: one related to the d, and the other one related to the IE. The lines in the 'd section' form the word *MAMMA* and *MAMA*. The two A's on the left and at the bottom are colored purple. Two clear M's are blue. The left legs of these M's coincide with the right side of the large A. The third M can be seen below the two M's. It coincides with the bottom A minus its somewhat rudimentary right side. A similar form can be seen at the bottom of the 'IE section'. If there's a *MAMMA* in there, too, then it's less clear. One section seems to have grown out of the other. This is also suggested by the 'section heads': the IE looks like the d with a stem leaking into an E/M. [di = lat. god]    
